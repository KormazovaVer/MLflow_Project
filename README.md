...
3. (Опционально) Публикует Docker образ в Docker Hub или другой registry.
...
4. (Опционально) Настройте секреты GitHub Actions (например, имя пользователя и пароль Docker Hub) для публикации образа.